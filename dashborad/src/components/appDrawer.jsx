        ...
        <List>
            ...
            <ListItem disablePadding sx={{ display: 'block' }}>
              <ListItemButton
                ...
                <ListItemText primary={"Productos"} sx={{ opacity: state.drawer ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
            ...
            <ListItem disablePadding sx={{ display: 'block' }}>
              <ListItemButton
                ...
                <ListItemText primary={"Categorias"} sx={{ opacity: state.drawer ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
            ...
            <ListItem disablePadding sx={{ display: 'block' }}>
              <ListItemButton
                ...
                <ListItemText primary={"Almacen"} sx={{ opacity: state.drawer ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
        </List>
      </Drawer>
