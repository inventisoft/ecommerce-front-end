...
const CrudServices = {
 ...
 /*    createProduct: async (data) => {
    ...
    getProductById: async (id) => {
        let response = {}
        await API.get('/product/view', { params: { id: id }, headers: authHeader() })
            .then(res => {
                response = res.data
            })
            .catch(error => {
    ...
    updateProduct: async (data, id) => {
        let response = {}
        await API.put('/product/update', data, { params: { id: id }, headers: authHeader({'Content-Type': 'application/x-www-form-urlencoded'})} )
            .then(res => {
                response =res
            }).catch(error => {
    ...
    deleteProduct: async (id) => {
        let response = {}
        await API.delete('/product/delete', {params: {id: id }, headers: authHeader()})
            .then(res => {
                response = res
            })
            .catch(error => {
